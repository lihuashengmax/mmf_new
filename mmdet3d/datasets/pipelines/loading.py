...
class MyResize(object):
    ...
    def __call__(self, results):
        ...
        # file_suffix = '_afterMyResize.png'
...
class MyLoadAnnotations3D(LoadAnnotations3D):
    ...
    def __call__(self, results):
        ...
        """
        results = super().__call__(results)
        self._load_bboxes_isfusion(results)
        self._load_labels_isfusion(results)
    ...
    def _load_bboxes_isfusion(self, results):
        ...
        results['gt_bboxes_isfusion'] = ann_info['bboxes_isfusion'].copy()

        gt_bboxes_ignore = ann_info.get('bboxes_ignore', None)
        if gt_bboxes_ignore is not None:
            results['gt_bboxes_ignore'] = gt_bboxes_ignore.copy()
            results['bbox_fields'].append('gt_bboxes_ignore')
        results['bbox_fields'].append('gt_bboxes_isfusion')
        return results

    def _load_labels_isfusion(self, results):
        """Private function to load label annotations.
        ...
        results['gt_labels_isfusion'] = results['ann_info']['labels_isfusion'].copy()
        return results
